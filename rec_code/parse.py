...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='colakg', help='rec-model, support [mf, lgn, colakg, colakg_useragg, colakg_useragg_ssl, colakg_useragg_att, colakg_useragg_gate]')
    parser.add_argument('--user_max_items', type=int, default=50, help='max items per user for CoLaKGUserAgg model')
